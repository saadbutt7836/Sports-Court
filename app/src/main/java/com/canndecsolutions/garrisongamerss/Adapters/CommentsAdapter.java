...
public class CommentsAdapter extends RecyclerView.Adapter<CommentsAdapter.CommentsViewHolder> {
    ...
    private List<CommentsModelClass> commentsList;
    ...
    public CommentsAdapter(Context context, List<CommentsModelClass> commentsList) {
    ...
    public void onBindViewHolder(@NonNull final CommentsViewHolder holder, int position) {
        ...
        final CommentsModelClass model = commentsList.get(position);
...
//                GET POST OWNER KEY AND RETRIEVE INFORMATION
    ...
    private void ShowCommets(CommentsModelClass model, CommentsViewHolder holder) {
